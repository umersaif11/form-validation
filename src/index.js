...
function checkPostalCode(){
    ...
    if(constraint.test(postalCodeField.value)){
        ...
        postalError.textContent = `${constraint[country][1]}`;
        postalError.className = "postal-code-error active";
    }
}
window.onload = () => {
  document.getElementById("user-country").onchange = checkPostalCode;
  document.getElementById("user-postal-code").oninput = checkPostalCode;
};
